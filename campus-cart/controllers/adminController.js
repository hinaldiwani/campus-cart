...
exports.createProduct = async (req, res, next) => {
  try {
    ...
    if (io) {
      ...
      realtimeEvents.emitProductUpdate("created", product);
    }
...
exports.updateProduct = async (req, res, next) => {
  try {
    ...
    if (io) {
      ...
      const eventType = existing.stock !== product.stock ? "stock-changed" : "updated";
      realtimeEvents.emitProductUpdate(eventType, product);
    }
...
exports.deleteProduct = async (req, res, next) => {
  try {
    ...
    if (io && product) {
      const realtimeEvents = new RealtimeEvents(io);
      realtimeEvents.emitProductUpdate("deleted", product);
    }
...
exports.updateOrderStatus = async (req, res, next) => {
  try {
    ...
    if (io && order) {
      const realtimeEvents = new RealtimeEvents(io);
      realtimeEvents.emitOrderUpdate("status-changed", order, order.user_id);
    }
...
exports.createCoupon = async (req, res, next) => {
  try {
    ...
    if (io && coupon) {
      const realtimeEvents = new RealtimeEvents(io);
      realtimeEvents.emitCouponUpdate("created", coupon);
    }
...
exports.toggleCoupon = async (req, res, next) => {
  try {
    ...
    if (io && coupon) {
      const realtimeEvents = new RealtimeEvents(io);
      realtimeEvents.emitCouponUpdate("updated", { ...coupon, is_active: !coupon.is_active });
    }
