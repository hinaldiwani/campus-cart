...
const PRODUCTS = [
  ...
  // Accessories
  {
    ...
    description:
      "Elegant rose gold and grey chronograph watch with crystal bezel. Perfect accessory for any occasion.",
    price: 799,
    original_price: 1299,
    stock: 25,
  ...
  // Men's Accessories
  {
    ...
    description:
      "Premium sterling silver Cuban link chain bracelet. Stylish and durable accessory for men.",
    price: 599,
    original_price: 999,
    stock: 30,
    image: "Silver Chain Bracelet.jpg",
    badge: "40% OFF",
    rating: 4.8,
    review_count: 87,
    sku: "MA-BR-001",
